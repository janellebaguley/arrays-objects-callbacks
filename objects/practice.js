...
let favoriteThings = {
  band: ['Face to Face', 'NoFx', 'Lagwagon'],
  food: ['Pizza', 'Yogurt', 'Chocolate'],
  person: ['Grams', 'Nieces', 'Nephews'],
  book: ['SeaPrincess', 'If You Meet the Buddha on the Road, Kill Him!'],
  movie: ['Gentlemen Prefer Blondes', 'Sabrina', 'My Fair Lady'],
  holiday: ['Halloween', 'Yule']
}
